...
- ID: 01
- Descripción:  React Router no encuentra ninguna ruta en la configuración  
  que coincida con la URL "/estudiantes". No routes matched location "/estudiantes".

- Pasos:  Paso 1: Acceder al menú:  <img width="1366" height="728" alt="menu" src="https://github.com/user-attachments/assets/91dd25ab-e27e-4bbf-90d7-fc7c1c54fb8e" /> 
